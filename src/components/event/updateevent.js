...
import Combinenav from '../../components/nav/combinednav/combinednav.js';
import Maingooter from '../../components/footer/Mainfooter/Mainfooter.js';
import Subfooter from '../../components/footer/Subfooter/Subfooter.js';
...
export default function UpdateEvents() {
  ...
  useEffect(() => {
    function getEvent() {
      axios
        .get(`http://localhost:3000/events/get/${id}`)
        .then((res) => {
          if (res.data.status) {
